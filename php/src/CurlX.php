...
class CurlX extends Helper
{
     ...
     * @throws CurlException
     */
    private function checkParams(?array $headers = null, string|null|CookieJarInterface $cookie = null, ?array $server = null): void
    {
        if (is_array($headers)) {
     ...
     * @throws Exception
     */
    public function get(string $url, ?array $headers = null, string|null|CookieJarInterface $cookie = null, ?array $server = null): object
    {
     ...
     * @throws Exception
     */
    public function post(string $url, string|array|null $data = null, ?array $headers = null, string|null|CookieJarInterface $cookie = null, ?array $server = null): object
    {
        $this->prepareHandle($url);
     ...
     * @throws CurlException
     */
    public function custom(string $url, string $method = 'GET', string|array|null $data = null, ?array $headers = null, string|null|CookieJarInterface $cookie = null, ?array $server = null): object
    {
        $this->prepareHandle($url);
