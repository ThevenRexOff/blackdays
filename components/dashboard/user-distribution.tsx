...
const data = [
  { name: 'Nuevos', value: 42, color: '#ef4444' },
    ...
    <div className="group relative overflow-hidden rounded-lg border border-red-900/30 bg-gradient-to-br from-[#0d0d0d] to-[#111111] p-5">
      ...
      <div className="absolute right-0 top-0 h-10 w-10">
        <svg viewBox="0 0 40 40" className="h-full w-full">
          <path d="M40,0 L28,0 L28,2 L38,2 L38,12 L40,12 Z" fill="rgba(220, 38, 38, 0.3)" />
        </svg>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative h-36 w-36">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="relative">
              ...
              <div className="absolute -inset-2 -z-10 rounded-full bg-red-500/10 blur-md" />
            </div>
          ...
          <div className="absolute inset-0 animate-[spin_20s_linear_infinite]">
            <svg viewBox="0 0 144 144" className="h-full w-full">
              <circle cx="72" cy="72" r="68" fill="none" stroke="rgba(220, 38, 38, 0.1)" strokeWidth="1" strokeDasharray="4 8" />
            </svg>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-3">
          {data.map((item, index) => (
            <div key={item.name} className="group/item flex items-center justify-between rounded-md p-2 transition-colors hover:bg-red-900/10">
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  />
                  {index === 0 && (
                    <div className="absolute inset-0 animate-ping rounded-sm bg-red-500/50" />
                  )}
                </div>
