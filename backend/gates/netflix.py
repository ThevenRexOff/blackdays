# ══════════════════════════════════════════════════════════════════════════
#  PURE motor for gate: netflix (Netflix MX). No Telegram-bot dependency.
# ══════════════════════════════════════════════════════════════════════════
import os


def _run_flow(card_input: str, proxy=None, capsolver_key: str = '') -> dict:
    from Commands.Gates.netflix.netflix_core import processNetflixFlow
    return processNetflixFlow(card_input, proxy=proxy, capsolver_key=capsolver_key, retries=0)
