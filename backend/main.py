...
def build_bot(query: str):
    ...
    bot.addCommand('mj',    'Commands.Gates.mj:gateCmd')
    bot.addCommand('mm',    'Commands.Gates.mm:gateCmd')
    bot.addCommand('wr',    'Commands.Gates.wr:gateCmd')
    bot.addCommand('br',    'Commands.Gates.br:gateCmd')
    bot.addCommand('bl',    'Commands.Gates.bl:gateCmd') # listo
    bot.addCommand('zb',    'Commands.Gates.zb:gateCmd') #TODO: arreglando flujo actualizado
    ...
    bot.addCommand('ds',    'Commands.Gates.disney:gateCmd')
    bot.addCommand('sfy',   'Commands.Gates.shopify:gateCmd')
    ...
    bot.addCallback('zb_monto',     'Commands.Gates.zb:zb_monto_cb')
